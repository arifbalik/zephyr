...
#define TSC_IO1_STH (0x1UL)
#define TSC_IO2_STH (0x2UL)
#define TSC_IO3_STH (0x4UL)
#define TSC_IO4_STH (0x8UL)

#define TSC_IO1_ASF (0x1UL)
#define TSC_IO2_ASF (0x2UL)
#define TSC_IO3_ASF (0x4UL)
#define TSC_IO4_ASF (0x8UL)
